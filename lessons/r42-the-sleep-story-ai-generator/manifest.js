...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R42 | R42 - The Sleep Story AI Generator',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      processInput: data.processInput || null,
      generateImages: data.generateImages || null,
      assembleVideo: data.assembleVideo || null,
    }
  };
