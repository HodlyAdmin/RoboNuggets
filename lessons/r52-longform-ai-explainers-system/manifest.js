...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R52 | R52 | Longform AI Explainers System',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      dataIngestion: data.dataIngestion || null,
      frameworkStructuring: data.frameworkStructuring || null,
      longformDrafting: data.longformDrafting || null,
      voiceoverGeneration: data.voiceoverGeneration || null,
    }
  };
