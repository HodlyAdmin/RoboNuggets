...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R51 | R51 | The Creative Cloner AI Agent System',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      sourceScraper: data.sourceScraper || null,
      conceptAnalyzer: data.conceptAnalyzer || null,
      scriptAdapter: data.scriptAdapter || null,
      videoRenderer: data.videoRenderer || null,
    }
  };
