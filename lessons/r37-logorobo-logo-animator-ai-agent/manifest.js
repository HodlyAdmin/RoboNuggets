...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R37 | R37 | LogoRobo - Logo Animator AI Agent',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      fetchInputData: data.fetchInputData || null,
      generatePrompt: data.generatePrompt || null,
      animateLogo: data.animateLogo || null,
    }
  };
