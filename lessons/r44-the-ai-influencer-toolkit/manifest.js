...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R44 | R44 - The AI Influencer Toolkit',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      scriptGen: data.scriptGen || null,
      imageGen: data.imageGen || null,
      voiceGen: data.voiceGen || null,
      videoGen: data.videoGen || null,
      publishSocial: data.publishSocial || null,
    }
  };
