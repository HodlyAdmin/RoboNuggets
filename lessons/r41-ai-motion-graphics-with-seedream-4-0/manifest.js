...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R41 | R41 | AI Motion Graphics (with Seedream 4.0)',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      storyboardCreation: data.storyboardCreation || null,
      motionGraphicsGen: data.motionGraphicsGen || null,
      workflowOrchestration: data.workflowOrchestration || null,
    }
  };
