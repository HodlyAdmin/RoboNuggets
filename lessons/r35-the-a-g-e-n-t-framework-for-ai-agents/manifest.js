...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R35 | R35 | The A.G.E.N.T. Framework for AI Agents',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      readSheet: data.readSheet || null,
      gatherResearch: data.gatherResearch || null,
      agentReasoning: data.agentReasoning || null,
      sendNotification: data.sendNotification || null,
    }
  };
