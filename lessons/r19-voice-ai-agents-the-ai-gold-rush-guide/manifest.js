...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R19 | R19 | Voice AI Agents: The AI Gold Rush Guide!',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      businessDataIngestion: data.businessDataIngestion || null,
      agentPromptGeneration: data.agentPromptGeneration || null,
      voiceDeployment: data.voiceDeployment || null,
