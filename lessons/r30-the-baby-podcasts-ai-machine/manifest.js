...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R30 | R30 | The Baby Podcasts AI Machine',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      scrapeTiktokVideos: data.scrapeTiktokVideos || null,
      generateBabyImage: data.generateBabyImage || null,
      generateBabyVideo: data.generateBabyVideo || null,
    }
  };
