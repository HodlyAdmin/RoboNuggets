...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R49 | R49 | Agentic Creative Systems',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      brandAgnosticIngestion: data.brandAgnosticIngestion || null,
      systemGuidelineApplication: data.systemGuidelineApplication || null,
