...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R22 | R22 | Build Samantha from "Her" as your AI Agent',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      conversationalAi: data.conversationalAi || null,
      sendEmail: data.sendEmail || null,
      manageCalendar: data.manageCalendar || null,
      taskAutomation: data.taskAutomation || null,
    }
  };
