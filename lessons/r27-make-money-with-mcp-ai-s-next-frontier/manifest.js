...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R27 | R27 | Make Money with MCP - AI\'s Next Frontier',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      aiAgentRouting: data.aiAgentRouting || null,
      leadScraping: data.leadScraping || null,
      dataFormatting: data.dataFormatting || null,
      cloudStorage: data.cloudStorage || null,
    }
  };
