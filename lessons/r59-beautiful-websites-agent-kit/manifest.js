...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R59 | Beautiful Websites Agent Kit',
    ...
    stages: {
      ...
      qualifyScreenshot: data.qualifyScreenshot || null,
      redesignGenerator: data.redesignGenerator || null,
      vercelDeploy: data.vercelDeploy || null,
    }
  };
