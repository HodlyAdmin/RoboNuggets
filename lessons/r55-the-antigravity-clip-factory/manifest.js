...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R55 | R55 | The Antigravity Clip Factory',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      telegramTrigger: data.telegramTrigger || null,
      generateClips: data.generateClips || null,
      queueForReview: data.queueForReview || null,
