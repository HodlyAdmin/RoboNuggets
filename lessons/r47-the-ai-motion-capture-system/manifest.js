...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R47 | R47 | The AI Motion Capture System',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      videoIngestion: data.videoIngestion || null,
      frameExtraction: data.frameExtraction || null,
      poseEstimation: data.poseEstimation || null,
      animationExport: data.animationExport || null,
    }
  };
