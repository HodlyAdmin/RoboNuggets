...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R38 | R38 | Infinite UGC Adverts AI System',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      inputSection: data.inputSection || null,
      ugcRoboAgent: data.ugcRoboAgent || null,
      videoGeneration: data.videoGeneration || null,
      outputSection: data.outputSection || null,
    }
  };
