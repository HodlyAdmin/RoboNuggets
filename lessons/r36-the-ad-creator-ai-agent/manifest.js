...
export async function saveManifest(data) {
  ...
  const manifest = {
    version: '1.0',
    lesson: 'R36 | R36 | The Ad Creator AI Agent',
    createdAt: new Date().toISOString(),
    config: { projectName: data.projectName },
    stages: {
      telegramWebhook: data.telegramWebhook || null,
      productVisionAnalysis: data.productVisionAnalysis || null,
      creativePromptGeneration: data.creativePromptGeneration || null,
    }
  };
